...
from sqlalchemy import Column, Integer, String, Date, DateTime, ForeignKey, Boolean, Numeric, Enum, Index
...
class ShoppingItem(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    plan_id = Column(Integer, ForeignKey("shopping_plans.id", ondelete="CASCADE"), nullable=False, index=True)
    ...
    __table_args__ = (
        Index('idx_shopping_item_plan_id', 'plan_id'),
    )
