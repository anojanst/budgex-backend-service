...
app.include_router(
    shopping_plans.router,
    prefix=f"{settings.API_V1_PREFIX}/shopping-plans",
    tags=["shopping-plans"],
)
app.include_router(
    saving_goals.router,
    prefix=f"{settings.API_V1_PREFIX}/saving-goals",
    tags=["saving-goals"],
)
app.include_router(
    balance_history.router,
    prefix=f"{settings.API_V1_PREFIX}/balance-history",
